                ...
                <table class="table mb-0" style="color: white;">
                    <thead>
                        <tr style="border-bottom: 1px solid rgba(255, 255, 255, 0.1);">
                            ...
                            <th class="border-0 px-4 py-3 text-right" style="font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted);">Purge</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr style="border-bottom: 1px solid rgba(255, 255, 255, 0.05);">
                                ...
                                <td class="px-4 py-4 align-middle text-right">
                                    <div class="d-flex justify-content-end align-items-center">
                                         <a href="{{ route('dashboard', ['device_id' => $device->id]) }}" class="btn btn-sm mr-2" style="background: rgba(59, 130, 246, 0.1); color: #60a5fa; border: 1px solid rgba(59, 130, 246, 0.2);" title="Inspect Live Dashboard">
                                             <i class="fas fa-eye"></i>
                                         </a>
                                         <form action="{{ route('admin.devices.destroy', $device) }}" method="POST" class="d-inline" onsubmit="return confirm('Immediately terminate this hardware node and all linked widgets?')">
                                             @csrf
                                             @method('DELETE')
                                             <button type="submit" class="btn btn-sm" style="background: rgba(239, 68, 68, 0.1); color: #f87171; border: 1px solid rgba(239, 68, 68, 0.2);" title="Purge Hardware">
